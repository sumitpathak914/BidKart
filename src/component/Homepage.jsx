                ...
                <div className="bg-white rounded-2xl overflow-hidden shadow-md shadow-slate-200/70 ring-1 ring-slate-100/50">
                  <div className="relative h-36 w-full">
                    <img
                      ...
                      className="w-full h-full object-cover"
                    />
                    <span className="absolute bottom-2 right-2 bg-black/60 backdrop-blur-sm text-white text-[9px] px-2 py-0.5 rounded-full">
                      {deal.shop}
                    </span>
                  </div>
                  <div className="p-3">
                    <p className="text-[13px] font-bold text-[#0F1638] truncate">
                      {deal.name}
                    </p>
                    <p className="text-[14px] font-extrabold text-[#D9A441] mt-0.5">
                      {deal.price}
                    </p>
                    <button
                      onClick={() => navigate(`/shop/${deal.id}`)}
