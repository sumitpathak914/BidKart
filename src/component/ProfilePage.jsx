...
//   const [switchForm, setSwitchForm] = useState({ businessName: "", email: "", pan: "" });
...
//     e.preventDefault();
//     alert(`Request submitted for ${switchForm.businessName}! We will review your application shortly.`);
//     setShowSwitchModal(false);
//     setSwitchForm({ businessName: "", email: "", pan: "" });
//   };

//   // --- NEW: Render Switch Modal ---
...
//         <div className="relative p-6 text-white" style={{ background: `linear-gradient(135deg, ${THEME.ink}, #2a3b7a)` }}>
//           <button 
...
//               <p className="text-sm text-white/80">Switch & unlock premium selling tools</p>
//             </div>
//           </div>
//         </div>
...
//                 <p className="text-xs font-bold text-[#0F1638]">Sell Products</p>
//               </div>
//               <p className="text-[10px] text-slate-500">List & auction your items</p>
//             </div>
...
//               </div>
//               <p className="text-[10px] text-slate-500">Connect with local buyers</p>
//             </div>
//             <div className="bg-purple-50 p-3 rounded-xl border border-purple-100">
//               <div className="flex items-center gap-2 mb-1">
//                 <Zap size={16} className="text-purple-600" />
//                 <p className="text-xs font-bold text-[#0F1638]">Direct Selling</p>
//               </div>
//               <p className="text-[10px] text-slate-500">Sell directly without auctions</p>
//             </div>
//             <div className="bg-amber-50 p-3 rounded-xl border border-amber-100">
//               <div className="flex items-center gap-2 mb-1">
//                 <TrendingUp size={16} className="text-amber-600" />
//                 <p className="text-xs font-bold text-[#0F1638]">Brand Promotion</p>
//               </div>
//               <p className="text-[10px] text-slate-500">Boost your brand visibility</p>
//             </div>
//           </div>
...
//             <p className="text-[11px] text-slate-600 font-medium">Unlock auction hosting & dedicated seller dashboard instantly!</p>
//           </div>
//         </div>
...
//               onChange={(e) => setSwitchForm({...switchForm, businessName: e.target.value})}
//             />
//             <input
//               type="email"
...
//               onChange={(e) => setSwitchForm({...switchForm, email: e.target.value})}
//             />
//             <input
//               type="text"
...
//               onChange={(e) => setSwitchForm({...switchForm, pan: e.target.value})}
//             />
//             <button
//               type="submit"
...
//                       <h3 className="text-[16px] font-extrabold">Switch to Business</h3>
//                     </div>
...
//                     <CheckCircle size={12} className="text-[#D9A441]" /> Sell Products
//                   </div>
//                   <div className="flex items-center gap-1 text-[10px] text-white/80">
//                     <CheckCircle size={12} className="text-[#D9A441]" /> Host Auctions
//                   </div>
//                   <div className="flex items-center gap-1 text-[10px] text-white/80">
//                     <CheckCircle size={12} className="text-[#D9A441]" /> Brand Promo
//                   </div>
//                 </div>
//               </div>
//             </div>
...
export default function ProfilePage() {
  ...
  const businessTools = [
    ...
    { id: "qrcode", label: "Shop QR Code", icon: QrCode, desc: "Generate & download QR code for your shop", count: null },
      ...
      <div className="bg-white w-full max-w-sm rounded-3xl overflow-hidden shadow-2xl animate-slide-up relative p-6">
        ...
        <div className="flex items-center gap-3 mb-4 pt-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Scan to visit {businessProfile.name}</p>
          </div>
        </div>
        ...
        <div className="mt-4 flex items-center gap-2 bg-slate-50 p-2 rounded-xl border border-slate-200">
          <p className="flex-1 text-xs text-slate-600 truncate px-2">{businessProfile.shopUrl}</p>
          <button 
