...
export default function CommunityChatPage() {
  ...
  return (
    <div className="h-auto bg-[#F6F5F1]  flex flex-col overflow-hidden pb-safe">
      <div className="mx-auto max-w-md w-full flex flex-col h-full relative">
        
        {/* --- HEADER (Fixed at Top) --- */}
        <header className="bg-white px-4 py-3 flex items-center justify-between border-b border-slate-100 flex-shrink-0 shadow-sm z-20">
        ...
        {/* --- CHAT MESSAGES AREA (Scrolling Area) --- */}
        <div className="flex-1 overflow-y-auto p-4 space-y-3 pb-28 mt-2"> {/* pb-28 provides room for the sticky input */}
        ...
        {/* --- BOTTOM INPUT AREA (100% Sticky Absolute Positioning) --- */}
        <div className="absolute bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-3 pb-safe shadow-[0_-4px_10px_rgba(0,0,0,0.03)] z-20 max-w-md mx-auto">
          <form onSubmit={handleSendMessage} className="flex items-center gap-2">
            <button type="button" className="p-2 text-slate-400 hover:text-[#0F1638] transition-colors">
              <ImageIcon size={20} />
            </button>
            <button type="button" className="p-2 text-slate-400 hover:text-[#0F1638] transition-colors">
              <Smile size={20} />
