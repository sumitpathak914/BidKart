...
// // Positions are percentages within the map card, tuned to echo the
// // reference layout (a loose ring of pins around "you are here").
// const PINS = [
...
//   return (
//     <div className="min-h-screen bg-[#F6F5F1] pb-28">
...
//         chatBadgeCount={6}
//         activeColorClass="text-[#0F1638]"
//         centerBgClass="bg-[#0F1638]"
//         badgeColorClass="bg-[#D9A441]"
//       />
//     </div>
//   );
// }
...
export default function ExplorePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F6F5F1] pb-28">
      ...
      {/* Bottom navigation on explore page */}
      <BottomNav
        active="explore"
        onChange={() => {}}
        chatBadgeCount={6}
